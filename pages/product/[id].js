...
<span class="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">(4.0 customer reviews)</span>
</div>
...
<hr></hr>
            ...
            <PriceRow className="mt-4">
              ...
              <div>
                <button className="button-prime" primary onClick={() => addProduct(product._id)}>
        Add to cart
                </button>
              </div>
            </PriceRow>
