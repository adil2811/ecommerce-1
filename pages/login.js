...
<div className="text-lg lg:text-xl text-center space-x-5 m-2">
                                                            ...
                                                            <button onClick={() => signIn('google')}>
                                                                <i 
                                                                    className="fa-brands fa-google-plus-g text-white bg-red-500 rounded-full px-[10px] py-[10px] ">Google</i>
                                                            </button>
                                                        </div>
                                                    ...
                                                    <div className="flex flex-col justify-center items-center m-2 space-y-6 md:space-y-8">
                                                        ...
                                                        <input type="email"  id="email_field" value={email} 
                 ...
                 onChange={(e) => setPassword(e.target.value)} /> 
                                                ...
                                                <div
                                                    ...
                                                    <div className="text-white text-base font-semibold text-center my-10 space-y-2 m-2">
                                                        ...
                                                        <Link href='/register' className="bg-white rounded-2xl px-4 text-emerald-400 py-1">SignUp</Link>
                                                    </div>
