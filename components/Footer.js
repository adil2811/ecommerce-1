...
<div className="space-y-9 grid grid-cols-1 md:grid-cols-2 md:pl-24 md:pr-16 lg:grid-cols-4 lg:px-7 xl:px-14 xl:ml-16">
    ...
    <div className="md:flex flex-col justify-between">
        <div className="text-[#747474] text-[15px] font-[550] leading-7 tracking-wide">
            ...
            <p className=""> <Link className="hover:text-[#cacaca]" href="#"> Return, Exchange and Refund</Link> </p>
            <p className=""> <Link className="hover:text-[#cacaca]" href="#"> Shipping Policy</Link> </p>
            <p className=""> <Link className="hover:text-[#cacaca]" href="#"> Terms and conditions</Link> </p>
            <p className=""> <Link className="hover:text-[#cacaca]" href="#"> Cancellation Policy</Link> </p>
    ...
    <div className="text-[#797878] text-[15px] font-[550] leading-6 tracking-wide md:order-4 lg:">
        ...
        <div className="leading-7 mt-4 text-[15px] font-[500]">
            ...
            <p className="space-x-3 hover:text-[#cacaca]"> <i className="fa fa-phone text-[17px]"></i> <Link
                    href="#">8452050281( <span className="text-[13px] font-[500]">General Enquiry</span> )</Link> </p>
          
            <p className="space-x-3 hover:text-[#cacaca]">  <Link href="#">
                    skadil718@gmail.com</Link> </p>
        </div>
    </div>
</div>
...
<div className="flex justify-center mb-4 md:mb-1 text-[#afafaf] text-center text-xl space-x-3">
    <p> <Link href="#"
            className="w-10 h-10 bg-[#474747] hover:text-blue-500 transform ease-in-out duration-500 hover:bg-white rounded-full inline-block pt-[7px]">
              <svg xmlns="http://www.w3.org/2000/svg" className='mt-[-5px]' loading="lazy"  width="35" height="35" viewBox="0 0 50 50">
    <path d="M25,3C12.85,3,3,12.85,3,25c0,11.03,8.125,20.137,18.712,21.728V30.831h-5.443v-5.783h5.443v-3.848 c0-6.371,3.104-9.168,8.399-9.168c2.536,0,3.877,0.188,4.512,0.274v5.048h-3.612c-2.248,0-3.033,2.131-3.033,4.533v3.161h6.588 l-0.894,5.783h-5.694v15.944C38.716,45.318,47,36.137,47,25C47,12.85,37.15,3,25,3z"></path>
  </svg>
                </Link> </p>
    <p> <Link href="#" className="w-10 h-10 bg-[#474747] hover:text-blue-500 transform ease-in-out duration-500 hover:bg-white rounded-full inline-block pt-[6px]">
    <svg
  ...
  >
    ...
    <p> <Link href="#"
            className="w-10 h-10 bg-[#474747] hover:text-blue-500 transform ease-in-out duration-500 hover:bg-white rounded-full inline-block pt-[6px]">
               <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"   loading="lazy" viewBox="0 0 50 50">
